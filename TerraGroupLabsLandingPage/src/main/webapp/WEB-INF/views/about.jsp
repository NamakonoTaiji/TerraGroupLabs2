...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<c:url value='/about'/>">会社概要</a></li>
    ...
    <header class="page-header py-5 mt-5 bg-light">
        <div class="container">
            <h1>会社概要</h1>
            <p class="lead">TerraGroup Labs（テラグループラボ）は、地球環境と人間社会の調和を目指す研究開発企業です。</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>TerraGroup Labsは、最先端のテクノロジーと自然環境の調和を図ることで、持続可能な社会の実現を目指します。人類の発展と地球環境の保全は両立可能であると信じ、その架け橋となる革新的なソリューションの開発に取り組んでいます。</p>
