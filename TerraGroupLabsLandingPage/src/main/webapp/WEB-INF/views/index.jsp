        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<c:url value='/'/>">ホーム</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<c:url value='/service'/>">サービス</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<c:url value='/about'/>">会社概要</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p class="lead text-center">
                                TerraGroup Labsは、持続可能な未来のためのテクノロジー開発を通じて、
                                地球環境と人類の共存を目指します。私たちは、革新的な研究開発と
                                社会実装を通じて、より良い社会の構築に貢献します。
                            </p>
                        </div>
                    </div>
                </div>
